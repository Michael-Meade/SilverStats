...
class Bar < Sql
	def input
		begin
			ct = @db.execute("create table IF NOT EXISTS Bar (id integer primary key autoincrement, bought_date text, 
				spot_price INTEGER,
				amount INTEGER,
				price real,
				shipping real,
		...
		@db.execute "insert into Bar values (?,?,?,?,?,?,?,?,?,?,?,?,?)", nil,r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11]
	end
	def avg_price
		count = 0
		total = 0
...
class JunkSilver < Sql
	def input
		begin
			ct = @db.execute("create table IF NOT EXISTS Junk (id integer primary key autoincrement, bought_date text, 
				spot_price INTEGER,
				amount INTEGER,
				price real,
				shipping real,
		...
		@db.execute "insert into Junk values (?,?,?,?,?,?,?,?,?,?,?,?,?)", nil,r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11]
	end
	def update_own(id)
